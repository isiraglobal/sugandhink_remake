...
function buildProductCard(product) {
    ...
    card.innerHTML = `
        ...
        <div class="pcard-footer">
            ...
            <a href="${waLink(product)}" target="_blank" rel="noopener" class="pcard-wa" onclick="event.stopPropagation();" aria-label="Order via WhatsApp">
    ...
    products.forEach(product => {
        ...
        item.innerHTML = `
            ...
            <div class="ld-info">
                ...
                <div class="ld-name">${product.name}</div>
