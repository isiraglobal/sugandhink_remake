...
function initData() {
    ...
    // 4. Mock Orders
    const mockOrders = [
        { id: 'ORD-9824', collector: 'Aarav Mehta', email: 'aarav.mehta@gmail.com', wa: '+91 98200 12345', items: 'Vanilla Luxe (30ml) × 2', value: '₹22,200', date: '25/05/2026', status: 'pending' },
        { id: 'ORD-9823', collector: 'Ishita Sharma', email: 'ishita.s@yahoo.com', wa: '+91 97690 98765', items: 'Oud Royal (100ml) × 1', value: '₹24,000', date: '22/05/2026', status: 'fulfilled' },
        { id: 'ORD-9822', collector: 'Rohan Singhal', email: 'rohan.singhal@outlook.com', wa: '+91 98110 54321', items: 'Oriental Spice (30ml) × 1, Dark Amber (30ml) × 1', value: '₹27,600', date: '20/05/2026', status: 'pending' }
    ];
